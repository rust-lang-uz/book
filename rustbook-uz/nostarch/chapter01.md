...
To acquire the build tools, you’ll need to install Visual Studio 2022 from *https://visualstudio.microsoft.com/downloads*. When asked which workloads to install, include:
